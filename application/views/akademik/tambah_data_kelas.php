				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card card-success">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="<?php echo base_url('akademik/tambah_data_kelas') ?>" method="post">
								<div class="card-body">
									<div class="form-group">
										<label>Kelas</label>
										<input type="text" name="nama_kelas" class="form-control" id="nama_kelas" placeholder="Kelas">
									</div>
									<div class="form-group">
