				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card card-success">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="<?php echo base_url('akademik/tambah_tahun_ajar') ?>" method="post">
								<div class="card-body">
									<div class="form-group">
										<label>Tahun Ajar</label>
										<input type="text" name="tahun_ajar" class="form-control" id="tahun_ajar" placeholder="Tahun Ajar">
									</div>
									<div class="form-group">
