				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card card-success">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="<?php echo base_url('akademik/tambah_mata_pelajaran') ?>" method="post">
								<div class="card-body">
									<div class="form-group">
										<label>Mata Pelajaran</label>
										<input type="text" name="nama_mapel" class="form-control" id="nama_mapel" placeholder="Mata Pelajaran">
									</div>
									<div class="form-group">
										<label>KKM</label>
										<input type="number" name="kkm" class="form-control" id="kkm" placeholder="KKM">
									</div>
								</div>
								<!-- /.card-body -->
