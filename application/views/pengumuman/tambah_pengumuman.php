				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card card-success">
							...
							<!-- /.card-header -->
							<!-- form start -->
							<form role="form" action="<?php echo base_url('pengumuman/tambah_pengumuman') ?>" method="post">
								<div class="card-body">
									<div class="form-group">
										<label>Judul Pengumuman</label>
										<input type="text" name="judul_pengumuman" class="form-control" id="judul_pengumuman" placeholder="Judul Pengumuman">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Tanggal</label>
										<input type="date" name="tanggal_pengumuman" class="form-control" id="tanggal">
									</div>
								</div>
								<!-- /.card-body -->
