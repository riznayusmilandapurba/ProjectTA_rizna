				...
				<div class="row">
					...
					<div class="col-sm-12">
						<div class="card card-success">
							...
							<?php echo form_open_multipart('profil/upload_profil') ?>
							<div class="card-body">
								<div class="form-group">
									<label>Nama Profil</label>
									<input type="text" name="nama_profil" class="form-control" id="nama_profil" placeholder="Nama Profil">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Gambar</label>
									<input type="file" class="form-control" name="image_profil" required>
								</div>
							</div>
							<!-- /.card-body -->
