					...
					<div class="col-sm-12">
						<div class="card card-success">
							<div class="card-header">
								<h3 class="card-title">Edit Data Rombel</h3>
							</div>
							<!-- /.card-header -->
							<!-- form start -->
								...
								<div class="card-body">
                                    ...
                                    m-group">
										...
										<select name="id_kelas" class="form-control">
											<option value="<?php echo $data_rombel->id_kelas ?>"><?php echo $data_rombel->nama_kelas ?></option>
									...
									<div class="form-group">
										...
										<select name="id_pengajar" class="form-control">
											<option value="<?php echo $data_rombel->id_pengajar ?>"><?php echo $data_rombel->nama_pengajar ?></option>
